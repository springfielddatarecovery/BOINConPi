...
customizeresearch () {
  ...
  while true; do
    read -p "Do you want to support umbrella research projects (World Community Grid, TN-GRID, BOINC@TACC, etc)? These are projects sponsored by (mostly) universities that enable researchers to crunch data having to develop their own seperate BOINC projects: " yn
    case $yn in
